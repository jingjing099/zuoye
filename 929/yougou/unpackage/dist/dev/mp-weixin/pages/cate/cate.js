          ...
          return {
            ...
            b: common_vendor.f(item.children, (child, idx, i1) => {
              return {
                ...
                c: idx,
                d: "5fba5c4e-5-" + i0 + "-" + i1 + "," + ("5fba5c4e-4-" + i0)
              };
            }),
            c: "5fba5c4e-4-" + i0 + ",5fba5c4e-3",
            d: index
          };
        }),
        d: common_vendor.p({
...
var MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "D:/\u7EC3\u4E60/\u4F5C\u4E1A/BestBuy-mall/pages/cate/cate.vue"]]);
